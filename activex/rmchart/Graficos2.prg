...
Procedure Graficador
   IF _IsWindowDefined( "Start" )
      oWnd:Show()
   ELSE
      CrearGrafica()
   ENDIF
...
Procedure CrearGrafica
   Define Window Start OBJ oWnd At 0,0 Width 480 Height 360  Title "Demo RMChart - |Serginio|" Modal  ON Size Ajust() ON Maximize Ajust() NOAUTORELEASE
