 ...
 *
 * This sample shows how to restore visual style to a
 * ProgressBar with Marquee style (the control shows a
 * never stopping animated bar), and how to programmaticaly
 * change the style.
 *
...
FUNCTION Main
   ...
   DEFINE WINDOW Form_1 ;
      ...
      @ 80,20 PROGRESSBAR Progress_2 ;
         ...
         SMOOTH ;
         VALUE 30 ;
         TOOLTIP 'Normal ProgressBar Control without visual styles. Click "Change Style" button to turn me into Marquee style.'
      ...
      @ 140,180 BUTTON Button_3 ;
         CAPTION "Visual Style" ;
         WIDTH 100 ;
         HEIGHT 28 ;
         ACTION CreateVisual() ;
         TOOLTIP 'Click to recreate with visual style.'
...
FUNCTION CreateVisual
   ...
   oProg2 := TProgressBar_RecreateWithoutColors( oProg2 )
...
/*
   ...
   @ 80,20 PROGRESSBAR Progress_2 ;
      ...
      SMOOTH ;
      VALUE 30 ;
      TOOLTIP 'Normal ProgressBar Control with visual styles. Click "Change Style" button to turn me into Marquee style.'
*/
   RETURN NIL
